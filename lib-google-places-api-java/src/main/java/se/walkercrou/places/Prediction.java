...
import static se.walkercrou.places.GooglePlacesImpl.*;
...
public class Prediction {
     ...
     */
    public static List<Prediction> parse(GooglePlacesImpl client, String rawJson) {
    ...
    protected Prediction setClient(GooglePlacesImpl client) {
        this.client = client;
        return this;
    }
