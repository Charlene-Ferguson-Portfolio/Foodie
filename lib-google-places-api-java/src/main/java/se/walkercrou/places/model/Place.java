package se.walkercrou.places.model;
...
import se.walkercrou.places.GooglePlacesImpl;
import se.walkercrou.places.Param;

import static se.walkercrou.places.GooglePlacesImpl.ARRAY_ADDRESS_COMPONENTS;
import static se.walkercrou.places.GooglePlacesImpl.ARRAY_ALT_IDS;
import static se.walkercrou.places.GooglePlacesImpl.ARRAY_ASPECTS;
import static se.walkercrou.places.GooglePlacesImpl.ARRAY_PERIODS;
import static se.walkercrou.places.GooglePlacesImpl.ARRAY_PHOTOS;
import static se.walkercrou.places.GooglePlacesImpl.ARRAY_REVIEWS;
import static se.walkercrou.places.GooglePlacesImpl.ARRAY_TYPES;
import static se.walkercrou.places.GooglePlacesImpl.BOOLEAN_OPENED;
import static se.walkercrou.places.GooglePlacesImpl.DOUBLE_LATITUDE;
import static se.walkercrou.places.GooglePlacesImpl.DOUBLE_LONGITUDE;
import static se.walkercrou.places.GooglePlacesImpl.DOUBLE_RATING;
import static se.walkercrou.places.GooglePlacesImpl.INTEGER_DAY;
import static se.walkercrou.places.GooglePlacesImpl.INTEGER_HEIGHT;
import static se.walkercrou.places.GooglePlacesImpl.INTEGER_PRICE_LEVEL;
import static se.walkercrou.places.GooglePlacesImpl.INTEGER_RATING;
import static se.walkercrou.places.GooglePlacesImpl.INTEGER_UTC_OFFSET;
import static se.walkercrou.places.GooglePlacesImpl.INTEGER_WIDTH;
import static se.walkercrou.places.GooglePlacesImpl.LONG_TIME;
import static se.walkercrou.places.GooglePlacesImpl.OBJECT_CLOSE;
import static se.walkercrou.places.GooglePlacesImpl.OBJECT_GEOMETRY;
import static se.walkercrou.places.GooglePlacesImpl.OBJECT_HOURS;
import static se.walkercrou.places.GooglePlacesImpl.OBJECT_LOCATION;
import static se.walkercrou.places.GooglePlacesImpl.OBJECT_OPEN;
import static se.walkercrou.places.GooglePlacesImpl.OBJECT_RESULT;
import static se.walkercrou.places.GooglePlacesImpl.STRING_ADDRESS;
import static se.walkercrou.places.GooglePlacesImpl.STRING_AUTHOR_NAME;
import static se.walkercrou.places.GooglePlacesImpl.STRING_AUTHOR_URL;
import static se.walkercrou.places.GooglePlacesImpl.STRING_ICON;
import static se.walkercrou.places.GooglePlacesImpl.STRING_INTERNATIONAL_PHONE_NUMBER;
import static se.walkercrou.places.GooglePlacesImpl.STRING_LANGUAGE;
import static se.walkercrou.places.GooglePlacesImpl.STRING_LONG_NAME;
import static se.walkercrou.places.GooglePlacesImpl.STRING_NAME;
import static se.walkercrou.places.GooglePlacesImpl.STRING_PHONE_NUMBER;
import static se.walkercrou.places.GooglePlacesImpl.STRING_PHOTO_REFERENCE;
import static se.walkercrou.places.GooglePlacesImpl.STRING_PLACE_ID;
import static se.walkercrou.places.GooglePlacesImpl.STRING_SCOPE;
import static se.walkercrou.places.GooglePlacesImpl.STRING_SHORT_NAME;
import static se.walkercrou.places.GooglePlacesImpl.STRING_TEXT;
import static se.walkercrou.places.GooglePlacesImpl.STRING_TIME;
import static se.walkercrou.places.GooglePlacesImpl.STRING_TYPE;
import static se.walkercrou.places.GooglePlacesImpl.STRING_URL;
import static se.walkercrou.places.GooglePlacesImpl.STRING_VICINITY;
import static se.walkercrou.places.GooglePlacesImpl.STRING_WEBSITE;
...
public class Place {
    ...
    private GooglePlacesImpl client;
     ...
     */
    public static Place parseDetails(GooglePlacesImpl client, String rawJson) {
        ...
        return new Place().setPlaceId(id).setClient(client).setName(name).setAddress(address).setIconUrl(iconUrl).setPrice(price)
     ...
     * @return client
     */
    public GooglePlacesImpl getClient() {
        return client;
    }

    /**
     * Sets the {@link GooglePlacesImpl} client associated with this Place object.
     *
     * @param client to set
     * @return this
     */
    protected Place setClient(GooglePlacesImpl client) {
        this.client = client;
        return this;
    }
